...
public class HashSetPerformance {
    ...
    public static void main(String[] args) {
        ...
        dataset.addValue(measureAddPerformance(hashSet, data), "Add(add)", "HashSet");

        dataset.addValue(measureReadPerformance(hashSet, data), "Read(contains)", "HashSet");

        dataset.addValue(measureRemovePerformance(hashSet, data), "Remove(remove)", "HashSet");

        JFreeChart chart = ChartFactory.createBarChart(
                "HashSet Operations Performance", 
                "Operation",
                "Time (ms)",
                dataset,
