...
public class ArrayListPerformance {
    ...
    public static void main(String[] args) {
        ...
        dataset.addValue(measureAddPerformance(arrayList, data), "Add(add)", "ArrayList");
        dataset.addValue(measureReadPerformance(arrayList, data), "Read(get)", "ArrayList");
        dataset.addValue(measureSearchPerformance(arrayList, data), "Search(contains)", "ArrayList");
        dataset.addValue(measureRemovePerformance(arrayList, data), "Remove(remove)", "ArrayList");
